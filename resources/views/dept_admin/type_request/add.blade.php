                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">បញ្ចូលព័ត៌មានប្រភេទសំណើរថ្មី</h3>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>ឈ្មោះនៃសំណើរ<span style="color: red">*</span></label>
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="បញ្ចូលឈ្មោះនៃសំណើរ" required> 
                                    ...
                                    <div class="form-group">
                                        <label>ប្រភេទនៃសំណើរ<span style="color: red">*</span></label>
                                            <select name="type_request" class="form-control">
                                                ...
                                                <option {{ old('type_request') == 'Leave' ? 'selected' : '' }} value="Leave">ឈប់សម្រាក</option>
                                                <option {{ old('type_request') == 'Mession' ? 'selected' : '' }} value="Mession">បំពេញការងារ​ ឬបេសកម្ម</option>
                                            </select>
