    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>​បញ្ជីប្រភេទនៃការស្មើសុំ <small style="color: rgb(0, 60, 255)">({{$getRecord->count()}} ប្រភេទ)</small></h1>
                    </div>
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ url('deptAdmin/type_Request/add') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> បន្ថែមប្រភេទនៃការស្មើសុំ</a>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label>ឈ្មោះនៃសំណើរ</label>
                                            <input type="text" value="{{ Request::get('name') }}" name="name"
                                                class="form-control" placeholder="ឈ្មោះនៃសំណើរ"> 
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>ប្រភេទនៃសំណើរ</label>
                                                <select name="type_request" class="form-control">
                                                    ...
                                                    <option {{ Request::get('type_request') == 'Mession' ? 'selected' : '' }} value="Mession">ការបំពេញការងារ</option>
                                                </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3 text-left">
                                            ...
                                            <a href="{{ url('deptAdmin/type_Request/list') }}" class="btn btn-success" style="margin-top: 32px;">
                            ...
                            <tbody>
                                @foreach ($getRecord as $department)
                                    <tr>
                                        ...
                                        <td>
                                            @if($department->type_request == 'Leave')
                                                ឈប់សម្រាក
                                            @elseif($department->type_request == 'Mession')
                                                បំពេញការងារ/បំពេញបេសកម្ម
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ url('deptAdmin/type_Request/edit/' . $department->id) }}"
                                                class="btn btn-primary btn-sm">Edit</a>
                                            <a href="{{ url('deptAdmin/type_Request/delete/' . $department->id) }}"
