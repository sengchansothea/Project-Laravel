    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>​បញ្ជីឈ្មោះដេប៉ាតឺម៉ង់ <small style="color: rgb(0, 60, 255)">({{$getRecord->count()}} ដេប៉ាតឺម៉ង់)</small></h1>
                    </div>
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ url('deptAdmin/department/add') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> បន្ថែមដេប៉ាតឺម៉ង់</a>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <tbody>
                                @foreach ($getRecord as $department)
                                    <tr>
                                        ...
                                        <td>{{ $department->name }} {{ $department->last_name }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ url('deptAdmin/department/edit/' . $department->id) }}"
                                                class="btn btn-primary btn-sm">Edit</a>
                                            <a href="{{ url('deptAdmin/department/delete/' . $department->id) }}"
