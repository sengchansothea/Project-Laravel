                        ...
                        <div class="card card-primary">
                            ...
                            <form method="POST">
                                ...
                                <div class="card-body">
                                        ...
                                        @foreach ($getDepartment as $department)
                                            <div>
                                                <label style="font-weight: normal">
                                                    <input name="dapartment_id[]" value="{{ $department->id }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($getTypeRequest as $typerequest)
                                            <div>
                                                <label style="font-weight: normal">
                                                    <input name="type_request_id[]" value="{{ $typerequest->id }}"
                                ...
                                <div class="card-footer">
                                    <a href="{{ url('deptAdmin/assign_department_approve_request/list') }}"
