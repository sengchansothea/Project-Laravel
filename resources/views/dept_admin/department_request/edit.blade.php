                                    ...
                                    <div class="form-group">
                                        {{-- <div class="form-group">
                                            ...
                                            <select name="type_requests_id" class="form-control" required>
                                                ...
                                                @foreach ($getTypeRequest as $typerequest)
                                                    <option {{ ($getRecord->type_requests_id == $typerequest->id) ? 'selected' : '' }} value="{{ $typerequest->id}}">{{$typerequest->name}}</option>
                                                @endforeach
                                            </select>
                                        </div> --}}
                                        <label>ប្រភេទនៃសំណើរ</label>
                                        ...
                                        @foreach ($getTypeRequest as $typerequest)
                                            @php
                                                $checked = '';
                                            @endphp
                                            @foreach ($getAssignTypeRequestID as $typeRequest)
                                                @if ($typeRequest->type_requests_id == $typerequest->id)
                                                    @php
                                                        $checked = 'checked';
                                                    @endphp
                                                @endif
                                            ...
                                            <div>
                                                <label style="font-weight: normal">
                                                    <input {{ $checked }} type="checkbox"
                                                        value="{{ $typerequest->id }}" name="type_requests_id[]">
                                                    {{ $typerequest->name }}
                                                </label>
                                            </div>
                                        @endforeach
