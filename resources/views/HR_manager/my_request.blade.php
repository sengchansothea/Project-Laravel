    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>HR manager Request List<small style="color: rgb(0, 60, 255)"></small></h1>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <tbody>
                                        @foreach ($getUserApproveDepartmentRequest as $employee)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('HR-manager/myRequest/approveRequest/' . $employee->id) }}" class="btn btn-primary btn-sm">
