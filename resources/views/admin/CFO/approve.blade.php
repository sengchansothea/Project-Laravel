    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>CEO Approve List<small style="color: rgb(0, 60, 255)"></small></h1>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2 text-left">
                                            ...
                                            <a href="{{ url('admin/CFO/approve/' . $CFO) }}" class="btn btn-success" style="margin-top: 32px;">
                        ...
                        <div class="card-body">
                            <div style="overflow-x: auto; width: 100%;">
                                <table class="table table-bordered" style="white-space: nowrap;">
                                    ...
                                    <tbody>
                                        @foreach ($getSearchApporveCFO as $employee)
                                        <tr>
