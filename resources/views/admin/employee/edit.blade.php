                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">បញ្ចូលព័ត៌មាន Employee</h3>
                            </div>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row column-md-12">
                                        ...
                                        {{-- <div class="form-group col-md-6">
                                           ...
                                           <select name="work_flow" class="form-control">
                                                ...
                                                <option {{ ($getRecord->work_flow  == 'Mession IT') ? 'selected' : '' }} value="Mession IT">Mession Department IT</option>
                                                <option {{ ($getRecord->work_flow  == 'Mession Sales') ? 'selected' : '' }} value="Mession Sales">Mession Department Sales</option>
                                                <option {{ ($getRecord->work_flow  == 'Other') ? 'selected' : '' }}value="Other">ផ្សេងៗ</option>
                                            </select>
                                        </div> --}}
                                        <div class="form-group col-md-6">
                                ...
                                <div class="card-footer">
                                    <a href="{{ url('admin/teamLeader/list') }}" class="btn btn-danger">បោះបង់</a>
