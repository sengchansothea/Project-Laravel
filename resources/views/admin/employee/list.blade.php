    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>​បញ្ជីឈ្មោះ Employee <small style="color: rgb(0, 60, 255)">({{ $getRecord->count() }} នាក់)</small></h1>
                    </div>
                    <div class="col-sm-6 text-right">
                        <a href="{{ url('admin/employee/add') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> បន្ថែម Employee
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 text-right">
                                            ...
                                            <a href="{{ url('admin/employee/list') }}" class="btn btn-success" style="margin-top: 32px;">
                                ...
                                <tbody>
                                    @foreach ($getRecord as $employee)
                                        <tr>
                                            ...
                                            <td>
                                                <small class="{{ $employee->status == 0 ? 'status-active' : 'status-inactive' }}">
                                                    {{ $employee->status == 0 ? 'បានអនុម័ត' : 'កំពុងរង់ចាំ' }}
                                                </small>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @elseif($employee->marital_status == 'Married')
                                                    បានរៀបការ
                                                @elseif($employee->marital_status == 'Other')
                                                    មិនបានបញ្ជាក់
                                                @endif
                                            </td>
                                            <td>{{ $employee->province_kh }}</td>
                                            <td>{{ $employee->created_at->format('d-m-Y H:i A') }}</td>
                                            <td>
                                                <a href="{{ url('admin/employee/edit/' . $employee->id) }}" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="{{ url('admin/employee/delete/' . $employee->id) }}" class="btn btn-danger btn-sm">
