    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>បន្ថែមឈ្មោះ Employee ថ្មី</h1>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">បញ្ចូលព័ត៌មាន Employee ថ្មី</h3>
                            </div>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row column-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="department_id" class="form-control">
                                                ...
                                                <option {{ (old('department_id') == 'Other') ? 'selected' : '' }}value="Other">ផ្សេងៗ</option>
                                            </select>
                                            <div style="color:red;">{{ $errors->first('gender') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        {{-- <div class="form-group col-md-6">
                                            <label>លំហូរការងារ</span></label>
                                           <select name="work_flow" class="form-control">
                                                <option value="">ជ្រើសរើសលំហូរការងារ</option>
                                                <option {{ (old('work_flow') == 'Mession IT') ? 'selected' : '' }} value="Mession IT">Mession Department IT</option>
                                                <option {{ (old('work_flow') == 'Mession Sales') ? 'selected' : '' }} value="Mession Sales">Mession Department Sales</option>
                                                <option {{ (old('work_flow') == 'Other') ? 'selected' : '' }}value="Other">ផ្សេងៗ</option>
                                            </select>
                                        </div> --}}
                                        <div class="form-group col-md-6">
                                ...
                                <div class="card-footer">
                                    <a href="{{ url('admin/employee/list') }}" class="btn btn-danger">បោះបង់</a>
