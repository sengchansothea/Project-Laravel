    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>TeamLeader Approve List<small style="color: rgb(0, 60, 255)"></small></h1>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2 text-left">
                                            ...
                                            <a href="{{ url('admin/teamLeader/approve/' . $TL) }}" class="btn btn-success" style="margin-top: 32px;">
