                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">បញ្ចូលព័ត៌មាន Department Admin ថ្មី</h3>
                            </div>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row column-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                           ...
                                           <select name="marital_status" class="form-control">
                                                ...
                                                <option {{ (old('marital_status') == 'Married') ? 'selected' : '' }} value="Married">រៀបការ</option>
                                                <option {{ (old('marital_status') == 'Single') ? 'selected' : '' }} value="Single">នៅលីវ</option>
                                ...
                                <div class="card-footer">
                                    <a href="{{ url('admin/department_admin/list') }}" class="btn btn-danger">បោះបង់</a>
