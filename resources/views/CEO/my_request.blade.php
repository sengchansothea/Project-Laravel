    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>CEO Request List<small style="color: rgb(0, 60, 255)"></small></h1>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card-body">
                            <div style="overflow-x: auto; width: 100%;">
                                <table class="table table-bordered" style="white-space: nowrap;">
                                    ...
                                    <tbody>
                                        @foreach ($getSearchEmployee as $employee)
                                            <tr>
                                                ...
                                                <td>{{ $employee->approver_name }} {{ $employee->approver_last_name }}</td>
                                                <td>
                                                    <a href="{{ url('CEO/myRequest/approveRequest/' . $employee->id) }}" class="btn btn-primary btn-sm">
